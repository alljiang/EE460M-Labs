...
HD_PWD='C:/Users/xchen/Documents/EE460M HDL Digital Sys/EE460M-Labs/Lab 3/Lab3_VivadoProject/Lab3_VivadoProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FitBit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FitBit.tcl
