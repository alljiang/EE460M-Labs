...
synth_design -top FitBit -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef FitBit.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file FitBit_utilization_synth.rpt -pb FitBit_utilization_synth.pb"
